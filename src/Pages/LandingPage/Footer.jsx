...
function Footer() {
    return (
        <>
            ...
            <footer className="p-4 sm:p-6 bg-[#1C1D1F]" style={{'zIndex':1000}}>
                <div className="md:flex md:justify-between">

                    <div className="grid grid-cols-2 gap-8 sm:gap-28 sm:grid-cols-3">
                        <div>
                            <ul className="text-white text-sm font-semibold ">
                                ...
                                <li className="mt-2" >
                                    <NavLink to="/" className="hover:underline">Profile</NavLink>
                                </li>
                            </ul>
                        </div>
                        <div>
                    ...
                    <div className="flex-initial flex">
                        ...
                        <div className="flex-initial"><span  className='text-2xl hidden md:block font-semibold md:mx-3 ml-8 text-gray-300'> Geez Learn </span></div>
                    </div>
                </div>
                <hr className="my-6 border-gray-200 sm:mx-auto  lg:my-8" />
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-300 sm:text-center font-custom-lora">© 2022 <a href="https://flowbite.com/" className="hover:underline ">Geez Learn</a>. All Rights Reserved.
                    </span>
