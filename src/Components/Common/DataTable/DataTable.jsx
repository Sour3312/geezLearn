                  ...
                  <tr className='' {...row.getRowProps()} >
                    {row.cells.map(cell => {
                      return <td
                        ...
                        className="px-2 py-2 bg-gray-50 text-left leading-4 text-sm text-gray-700 tracking-wider border-b"
